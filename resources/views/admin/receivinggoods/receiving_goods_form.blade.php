                    ...
                    <div class="card-body" id="rg_card_body">
                        <form method="post" id="purchaseorderForm" class="form-horizontal ">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="purchase_action" id="purchase_action" value="{{$action}}" />
...
$(document).on('click', '#btn_cal', function(){
    ...
    var prev_bal = $('#prev_bal').val();

    $.ajax({
        url:"/admin/validation_payable",
        type : 'GET',
        data: {
            cash:cash, payment:payment, prev_bal:prev_bal, _token: '{!! csrf_token() !!}'
        },
        dataType:"json",
        success:function(data){
